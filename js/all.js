...
// Obtener el enlace y el pop-up para "Sobre Mi"
var link = document.getElementById('sobreMiLink');
var popup = document.getElementById('popup');
var closeBtn = document.getElementsByClassName('close')[0];

// Obtener el enlace y el pop-up para "Reels"
var reelsLink = document.getElementById('reelsLink');
var reelsPopup = document.getElementById('reelsPopup');
var reelsCloseBtn = reelsPopup.getElementsByClassName('close')[0];

// Obtener el primer video en el pop-up de "Reels"
var reelsVideo = document.getElementById('reelsVideo');

// Mostrar el pop-up al hacer clic en el enlace "Sobre Mi"
link.onclick = function(event) {
    event.preventDefault(); // Prevenir el comportamiento por defecto del enlace
    popup.style.display = 'block';
}

// Mostrar el pop-up al hacer clic en el enlace "Reels"
reelsLink.onclick = function(event) {
    event.preventDefault(); // Prevenir el comportamiento por defecto del enlace
    reelsPopup.style.display = 'block';
    reelsVideo.play(); // Reproducir el primer video automáticamente
}

// Cerrar el pop-up "Sobre Mi" al hacer clic en el botón de cerrar
closeBtn.onclick = function() {
    popup.style.display = 'none';
}

// Cerrar el pop-up "Reels" al hacer clic en el botón de cerrar
reelsCloseBtn.onclick = function() {
    reelsPopup.style.display = 'none';
    reelsVideo.pause(); // Pausar el video cuando se cierra el pop-up
    reelsVideo.currentTime = 0; // Reiniciar el video al principio
}

// Cerrar los pop-ups al hacer clic fuera del contenido del pop-up
window.onclick = function(event) {
    if (event.target == popup) {
        popup.style.display = 'none';
    } else if (event.target == reelsPopup) {
        reelsPopup.style.display = 'none';
        reelsVideo.pause(); // Pausar el video cuando se cierra el pop-up
        reelsVideo.currentTime = 0; // Reiniciar el video al principio
    }
